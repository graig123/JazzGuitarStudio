...
def draw_single_chord(chord1, chord2, count_color):  # chord1 = lijst met alle chords, chord2 = 'drop2_inv1_strS1', count_color= een getal 0tot 4
    ...
    for x in chord1:
        if intr[count] == 'R':
            ...
            svg_t.append('<circle cx="')
            svg_t.append(ver)
            svg_t.append('" cy="')
            svg_t.append(hor)
            svg_t.append('" r="11" stroke="')
            svg_t.append(color2)
            svg_t.append('" stroke-width="3" fill="')
            svg_t.append(color2)
            svg_t.append('" ><title>')
            svg_t.append(chord)
            svg_t.append('</title></circle>\n<g>\n<circle cx="')
            svg_t.append(ver)
            svg_t.append('" cy="')
            svg_t.append(hor)
            svg_t.append('" r="10" stroke="')
            svg_t.append(color1)
            svg_t.append('" stroke-width="3" fill="')
            svg_t.append(color2)
            svg_t.append('" ><title>')
            ...
            svg_t.append('" y="')
            svg_t.append(hor)
            svg_t.append('" text-anchor="middle" stroke="')
            svg_t.append(color1)
            svg_t.append('" stroke-width="1px" dy=".35em">')
            svg_t.append(interval)
            svg_t.append('</text>\n</g>\n')
            count += 1
        else:
            if x == 0:
            ...
            svg_t.append('" r="10" stroke="')
            svg_t.append(color2)
            svg_t.append('" stroke-width="2" fill="')
            svg_t.append(color1)
            svg_t.append('" ><title>')
            svg_t.append(chord)
            svg_t.append('</title></circle>\n<text x="')
...
def create_svg(cchord, shape, chordcolor):  # bv: cchord='D#m7' shape='drop3_inv2_strS1' chordcolor=1
    if cchord[1] in ('#', 'b'):
        a1 = cchord[:2]
        ...
        a3 = eval(shape[0:ss])
        print(shape[0:ss])
        xx = guitar.chord_list_generator(a1, a2, a3)
        draw_single_chord(xx, shape, chordcolor)
        return svg_t
...
#create_svg('CM7', 'drop2_inv4_strS2', 0)
